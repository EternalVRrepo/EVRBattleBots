...
/////// Normals:
                float2 node_180 = i.uv0;
                float3 normalLocal = tex2D(_Normal,TRANSFORM_TEX(node_180.rg, _Normal)).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
////// Lighting:
////// Emissive:
                float4 node_2 = tex2D(_Diffuse,TRANSFORM_TEX(node_180.rg, _Diffuse));
