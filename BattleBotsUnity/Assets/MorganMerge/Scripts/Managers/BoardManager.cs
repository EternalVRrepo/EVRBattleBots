...
public class BoardManager : MonoBehaviour {
	...
	/// </summary>
	public List<Hexagon> GetPath(Hexagon start, Hexagon end) {
		AStarSearch astar = new AStarSearch(HexagonArray, start, end);
	...
	/// </summary>
	public List<Hexagon> GetNeighborsMovement(Hexagon start) {
