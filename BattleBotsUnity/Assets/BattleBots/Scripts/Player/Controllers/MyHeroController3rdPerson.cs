...
//			cameraController.LookAt (transform.position); //Look At Player
//			cameraController.eulerAngles = new Vector3 (0, cameraController.eulerAngles.y, cameraController.eulerAngles.z); //Even Out Ground Plane
